...
const SammarySction = () => {
  return (
    <div className=" ovreflow-x-hidden w-full">
      <motion.section
      ...
      >
        ...
        >
          ...
          interfaces, CRM solutions, and bilingual CMS platforms. Strong
          expertise in PostgreSQL database design, server-side rendering,
          authentication systems, and performance optimization, consistently
          delivering responsive, production-ready applications with clean,
          maintainable code.
        </motion.p>
      </motion.section>
    </div>
